...
public class CreateSendTicketOrderRepo extends BaseApiClient {
    ...
    public void sendTicket(CreateSendTicketOrderBody body, CallbackCreateSendTicketOrder callback) {
        // Call API
        ...
        enqueue(call, new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    CreateSendTicketOrderModel createOrderCardModel = new Gson().fromJson(response.body(), CreateSendTicketOrderModel.class);
                    mainThread.post(() -> {
                        callback.onSuccess(createOrderCardModel);
                    });
                } else {
